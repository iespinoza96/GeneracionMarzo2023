...
namespace DL_EF2
{
    ...
    public partial class IEspinozaProgramacionNCapasGF2023Entities : DbContext
    {
        ...
        public virtual int AlumnoChangeStatus(Nullable<int> idAlumno, Nullable<bool> status)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoChangeStatus", idAlumnoParameter, statusParameter);
        }
